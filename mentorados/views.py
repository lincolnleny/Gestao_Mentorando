...
def mentorados(request):
    if request.method == 'GET':
        ...
        estagios__flat = [i[1] for i in Mentorados.estagio_choices]
        qtd_estagios = []
        ...
        return render(request, 'mentorados.html', {'estagio': Mentorados.estagio_choices, 'navigators': navigators, 'mentorados': mentorados, 'estagios_flat': estagios__flat, 'qtd_estagios': qtd_estagios})
